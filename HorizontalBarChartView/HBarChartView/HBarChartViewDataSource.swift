...
protocol HBarChartViewDataSource:class {
    ...
    func hBarChartView(_ hBarChartView:HBarChartView, attributeForBarLabelAt index:Int) -> [NSAttributedStringKey:Any]
    func hBarChartView(_ hBarChartView:HBarChartView, attributeForValueLabel index:Int) -> [NSAttributedStringKey:Any]
}
